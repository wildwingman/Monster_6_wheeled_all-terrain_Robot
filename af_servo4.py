...
servo15Min = 220 # Min pulse length out of 4096
servo15Max = 785  # Max pulse length out of 4096
...
while (True):
  ...
  pwm.setPWM(1, 0, servo1Min)
  pwm.setPWM(15, 0, servo1Min)
  ...
  pwm.setPWM(1, 0, servo1Max)
  pwm.setPWM(15, 0, servo15Max)
